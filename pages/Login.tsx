...
import { Lock, User, Eye, School, GraduationCap, X, Briefcase, ChevronRight, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-background-light items-center justify-center p-4">
      ...
      <div className="absolute inset-0 z-0">
        <img alt="Background" className="w-full h-full object-cover opacity-10" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA_QkZffvjimURDEcQAlwn5SvaF7rKxlFxtBHZnNLdJ2s4J8l0RnxP8gHGZR2Mad5_DcE2wnu7GWqx5sdJPh3a6hPzWPtJ1kTXUbmSs5uXuTibebGEQfurmxyHH0f7W4he8o5wb1kkUu8Yeo8cmc4Ks_1fQWHKgMsFAYszH3rL-TsUxrcj_Z0bavrb_B45-kYjoh3bR-VmpccL8YO-rktXlW8N6NmgtTpX8YskS1zxgq9CvRN6Lml6nIQJP084Xr96ke6_IIr1ccYg" />
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col gap-6 rounded-2xl bg-white p-8 shadow-xl border border-surface-dim">
        ...
        <form className="flex flex-col gap-5 mt-2" onSubmit={handleLoginSubmit}>
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium leading-normal text-text-main pl-1" htmlFor="username">
              Tên đăng nhập
            </label>
            <div className="relative flex items-center">
              <User size={20} className="absolute left-4 text-text-secondary select-none" />
              <input 
                id="username" 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium leading-normal text-text-main pl-1" htmlFor="password">
              Mật khẩu
            </label>
            <div className="relative flex items-center">
              <Lock size={20} className="absolute left-4 text-text-secondary select-none" />
              <input 
                id="password" 
              ...
              />
              <button type="button" className="absolute right-4 text-text-secondary hover:text-text-main">
                <Eye size={20} />
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between px-1">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="h-4 w-4 rounded border-surface-dim text-primary focus:ring-primary bg-background-light" />
        ...
        <div className="mt-2 text-center text-sm text-text-secondary">
          Cần hỗ trợ? <a href="#" className="font-bold text-text-main hover:underline">Liên hệ quản trị viên</a>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
           <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center gap-6 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex flex-col items-center text-center gap-2 mt-2">
                 ...
                 <h2 className="text-2xl font-bold text-text-main">Chọn vai trò</h2>
                 <p className="text-sm text-text-secondary">Vui lòng chọn vai trò để tiếp tục</p>
              </div>
              ...
              <div className="flex flex-col gap-3 w-full">
                 ...
                 >
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm uppercase tracking-wide">Học sinh</span>
                    </div>
                    <ChevronRight size={18} className="text-text-secondary group-hover:text-text-main transition-colors" />
                 </button>
                 ...
                 >
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm uppercase tracking-wide">Giáo viên</span>
                    </div>
                    <ChevronRight size={18} className="text-text-secondary group-hover:text-text-main transition-colors" />
                 </button>
                 ...
                 >
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm uppercase tracking-wide">Cán bộ học vụ</span>
                    </div>
                    <ChevronRight size={18} className="text-text-secondary group-hover:text-text-main transition-colors" />
                 </button>
                 ...
                 >
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm uppercase tracking-wide">Ban Giám Hiệu</span>
                    </div>
                    <ChevronRight size={18} className="text-text-secondary group-hover:text-text-main transition-colors" />
                 </button>
              </div>
